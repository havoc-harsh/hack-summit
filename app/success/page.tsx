...
import styles from '../../styles/success.module.css'; // Import your CSS module
...
export default async function SuccessPage({ searchParams }: SuccessPageProps) {
  ...
  return (
    <div className={styles.container}>
      ...
      <h2 className={styles.statusText}>{statusContent.text}</h2>
      ...
      <a href="/hospital" className={styles.retryButton}>
        Return
      </a>
    </div>
  );
